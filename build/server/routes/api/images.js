...
images.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var image, imageHeight, imageWidth, queryHasImage, queryHasHeight, queryHasWidth, currentDir, fullImagesDir, thumbImagesDir, imagePathFull, imagePathThumb;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!queryHasImage) return [3 /*break*/, 6];
                if (!fs_extra_1.default.existsSync("".concat(imagePathFull, "/").concat(image, ".jpg"))) return [3 /*break*/, 5];
                ...
                return [3 /*break*/, 4];
            case 1:
                if (!(queryHasHeight && queryHasWidth)) return [3 /*break*/, 3];
                // Resize the image based on image dimensions passed to the URL
                return [4 /*yield*/, (0, sharp_1.default)("".concat(imagePathFull, "/").concat(image, ".jpg"))
                        .resize(imageWidth, imageHeight)
                        .toFile("".concat(imagePathThumb, "/").concat(image, "_").concat(imageHeight, "_").concat(imageWidth, ".jpg"))];
            case 2:
                // Resize the image based on image dimensions passed to the URL
                _a.sent();
